...
@curl -L https://raw.github.com/gullitmiranda/oh-my-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@

h3. The manual way

1. Clone the repository:

@git clone git://github.com/gullitmiranda/oh-my-zsh.git ~/.oh-my-zsh@
...
* enable the plugins you want in your @~/.zshrc@ (take a look at the @plugins/@ directory and the "wiki":https://github.com/gullitmiranda/oh-my-zsh/wiki/Plugins to see what's available)
** example: @plugins=(git osx ruby)@
* theme support: change the @ZSH_THEME@ environment variable in @~/.zshrc@
** take a look at the @themes/@ directory and the "wiki":https://wiki.github.com/gullitmiranda/oh-my-zsh/themes to see what comes bundled with @oh-my-zsh@
...
If you have many functions that go well together, you can put them as a @*.plugin.zsh@ file in the @custom/plugins/@ directory and then enable this plugin (see '"Usage":https://github.com/gullitmiranda/oh-my-zsh#usage' above).
...
This project wouldn't exist without all of our awesome users and contributors: "view our growing list of contributors":https://github.com/gullitmiranda/oh-my-zsh/contributors
